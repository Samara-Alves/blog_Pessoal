...
public class PostagemController {
    ...
    public ResponseEntity<List<Postagem>> GetByTítulo(@PathVariable String título) {
    	return ResponseEntity.ok(repositoty.findAllByTituloContainingIgnoreCase(título));
